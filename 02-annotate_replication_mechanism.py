...
DEFAULT_DB = "data/rep_plasmid_core_db.hmm"
DEFAULT_RULES = "data/pfam_replication_mechanism_table.tsv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--chunksize", type=int, default=20000, help="CSV rows to process per chunk.")
