...
# ================= 配置区域 =================
clstr_file = "cd_hit_process.fasta.clstr"  # 你的 .clstr 文件
output_file = "cdhit_redundancy_fixed90.png"
...
# --- 图 1: 簇大小分布 (柱状图) ---
# 统计每个大小出现的频次 (例如：大小为 1 的有 500 个，大小为 2 的有 100 个...)
size_counts = sizes_series.value_counts().sort_index()

# 为了图形美观，如果最大值太大，只显示前 20 个或者截取一部分
